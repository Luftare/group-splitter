    ...
    >
      <div
        style={{
          ...
          gap: theme.sizes.spacing * 8,
          flexWrap: "wrap",
        }}
      >
        <div>
          <h3 style={{ marginBottom: theme.sizes.spacing }}>By Number</h3>
        ...
        <div>
          <h3 style={{ marginBottom: theme.sizes.spacing }}>By Letter</h3>
        ...
        <div>
          <h3 style={{ marginBottom: theme.sizes.spacing }}>By Color</h3>
        ...
        <div>
          <h3 style={{ marginBottom: theme.sizes.spacing }}>By Shape</h3>
